...
import { deleteCouponAction } from '@/lib/actions/couponActions';
  ...
  return (
    <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
      <AlertDialogTrigger asChild>
        <Button variant="ghost" size="icon" title={`Eliminar ${couponCode}`} disabled={isPending}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Esta acción no se puede deshacer. Esto eliminará permanentemente el cupón <strong>{couponCode}</strong>.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
