        ...
        {currentUser.role === 'admin' && (
          <>
            <Card>
              <CardHeader>
                <div className="flex justify-between items-center">
                    <CardTitle>Gestión de Agentes de IA</CardTitle>
                    <Button asChild variant="outline">
                        <Link href={AppRoutes.admin.configuracionesAgentes}>
                            <Bot className="mr-2 h-4 w-4"/> Configurar Agentes
                        </Link>
                    </Button>
                </div>
                <CardDescription>Personaliza los asistentes de inteligencia artificial que interactúan en la aplicación.</CardDescription>
              </CardHeader>
            </Card>
